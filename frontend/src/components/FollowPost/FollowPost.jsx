...
const FollowPost = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://meraki-academy-project-5-a2ze.onrender.com/followers/userFollowers/${auth.userId}`,
        {
          headers: {
    ...
    axios
      .get(
        `https://meraki-academy-project-5-a2ze.onrender.com/posts/search_1/${followers.result.following_user_id}`,
        {
          headers: {
            authorization: `Bearer ${auth.token}`,
          },
