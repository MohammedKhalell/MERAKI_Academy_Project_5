...
const Posts = () => {
  ...
  const { posts, auth, comment, userId, users, like, personal } = useSelector(
    (state) => {
      return {
        auth: state.auth,
  ...
  const handleCreateNewPost = () => {
    ...
    axios
      .post(
        "https://meraki-academy-project-5-a2ze.onrender.com/posts",
        NewPost,
        {
          headers: {
  ...
  const handleDeletePost = (postId) => {
    axios
      .delete(
        `https://meraki-academy-project-5-a2ze.onrender.com/posts/${postId}`,
        {
          headers: {
            authorization: `Bearer ${auth.token}`,
          },
  ...
  useEffect(() => {
    axios
      .get("https://meraki-academy-project-5-a2ze.onrender.com/posts")
      .then((result) => {
  ...
  useEffect(() => {
    axios
      .get("https://meraki-academy-project-5-a2ze.onrender.com/likes")
      .then((result) => {
