...
const UsersPage = () => {
  const { posts, users, auth, followers, counter, amount, search } =
    useSelector((state) => {
      return {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://meraki-academy-project-5-a2ze.onrender.com/posts/followers/${id}`,
        {
          headers: {
            authorization: `Bearer ${auth.token}`,
          },
    ...
    axios
      .get(`https://meraki-academy-project-5-a2ze.onrender.com/users/${id}`)
      .then((result) => {
